...
VIEWER_SHORTCUTS_PLAY_PAUSE = "播放／暫停"
VIEWER_SHORTCUTS_SEEK = "快退／快進 5 秒"
VIEWER_PLAYER_UNAVAILABLE = "您的瀏覽器不支援播放此媒體格式。"
VIEWER_SEEK_TO = "跳至此時間點"
VIEWER_SHARE = "分享"
VIEWER_SHARE_LINK_CREATED = "已產生分享連結"
VIEWER_SHARE_LINK_LABEL = "分享連結"
VIEWER_SHARE_COPY_LINK = "複製連結"
VIEWER_SHARE_LINK_COPIED = "已複製"
VIEWER_SHARE_REVOKE = "取消分享"
VIEWER_SHARE_REVOKE_CONFIRM = "確定要取消分享嗎？已分享的連結將失效。"
VIEWER_SHARE_REVOKE_CONFIRM_BUTTON = "確認取消"
VIEWER_SHARED_TITLE = "共享逐字稿：{name}"
VIEWER_SHARED_BADGE = "共享逐字稿"
